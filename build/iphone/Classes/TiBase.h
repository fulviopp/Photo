...
// in simulator we redefine to format for Photo Developer console
...
{\
	NSString * exceptionName = [@"org.photo." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.photo";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPhotoNativeItemNone = -1, 
	UIPhotoNativeItemSpinner = -2,
	UIPhotoNativeItemProgressBar = -3,
	
	UIPhotoNativeItemSlider = -4,
	UIPhotoNativeItemSwitch = -5,
	UIPhotoNativeItemMultiButton = -6,
	UIPhotoNativeItemSegmented = -7,
	
	UIPhotoNativeItemTextView = -8,
	UIPhotoNativeItemTextField = -9,
	UIPhotoNativeItemSearchBar = -10,
	
	UIPhotoNativeItemPicker = -11,
	UIPhotoNativeItemDatePicker = -12,
	
	UIPhotoNativeItemInfoLight = -13,
	UIPhotoNativeItemInfoDark = -14,
	
	UIPhotoNativeItemDisclosure = -15,
	
	UIPhotoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Photo instances of
